...
def img_vgg_f(input_image, bit, model_weights=None):
	if model_weights is None:
		dir_path = os.path.dirname(os.path.realpath(__file__))
		model_weights = os.path.join(dir_path, "pretrained_model/imagenet-vgg-f.mat")

	print("loading model from ", model_weights)
	data = scipy.io.loadmat(model_weights)
